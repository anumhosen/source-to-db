                    ...
                    <div className='max-w-2xl w-full'>
                        ...
                        <div className='text-center mb-4'>
                            ...
                            <p className='text-gray-400 text-lg max-w-md mx-auto'>
                                Import code repositories, generate AI documentation, and build
                                polished docs
                            </p>
                        </div>
                        ...
                        <div className='grid grid-cols-2 gap-4 mb-4'>
                            <button
                                ...
                                className='flex flex-col items-center gap-3 p-6 bg-gray-900 border border-gray-800 rounded-xl 
                           hover:border-indigo-700 hover:bg-gray-850 transition-all group'
                            >
                           ...
                           hover:border-indigo-700 hover:bg-gray-850 transition-all group'
                            >
                                ...
                                <div className='text-center'>
                                    ...
                                    <p className='text-gray-500 text-sm'>
                                        Browse for an existing database
                                    </p>
                                </div>
                            </button>
                        </div>
                        ...
                        ${index === 0 ? 'bg-indigo-900/30' : 'bg-gray-800'}`}
                                            >
                                                <VscDatabase
                                            ...
                                            <div className='flex-1 min-w-0'>
                                                <div className='flex items-center gap-2'>
                                                    ...
                                                    {index === 0 && (
                                                        <span className='text-[10px] px-1.5 py-0.5 bg-indigo-900/30 text-indigo-400 rounded font-medium flex-shrink-0'>
                                                            LATEST
                                                        </span>
                                                    )}
                                                </div>
                        ...
                        <div className='mt-8 grid grid-cols-3 gap-4'>
                            <div className='flex items-start gap-2 p-3'>
                                <VscFiles className='w-4 h-4 text-gray-600 mt-0.5 flex-shrink-0' />
                                <div>
                                    <h4 className='text-xs font-medium text-gray-400 mb-0.5'>
                                        Import Repos
                                    </h4>
                                    <p className='text-xs text-gray-600'>
                                        Local folders & Git repos
                                    </p>
                                </div>
                            </div>
                            <div className='flex items-start gap-2 p-3'>
                                <VscCircuitBoard className='w-4 h-4 text-gray-600 mt-0.5 flex-shrink-0' />
                                <div>
                                    <h4 className='text-xs font-medium text-gray-400 mb-0.5'>
                                        AI Documentation
                                    </h4>
                            ...
                            <div className='flex items-start gap-2 p-3'>
                                <VscBook className='w-4 h-4 text-gray-600 mt-0.5 flex-shrink-0' />
                                <div>
                                    <h4 className='text-xs font-medium text-gray-400 mb-0.5'>
                                        Build Docs
                                    </h4>
                    ...
                    {repos.length > 0 && (
                        <div className='relative mb-4 flex-shrink-0'>
                            ...
                            <input
                                ...
                                className='w-full pl-9 pr-4 py-2 bg-gray-900 border border-gray-800 rounded-lg text-sm 
                           text-gray-200 placeholder-gray-500 focus:outline-none focus:border-indigo-700'
                            />
                            {searchQuery && (
                                <button
                            ...
                            ${
                                repo.source === 'git'
                                    ...
                                    : 'bg-yellow-900/30 text-yellow-400'
                                                    ...
                                                    {repo.version && repo.version !== 'local' && (
                                        ...
                                        {repo.timestamp && (
                                            <p className='text-xs text-gray-600 mb-3'>
                                                Added {formatDate(repo.timestamp)}
                                            </p>
                                        )}
